...
const P1 = { x: FT_X + FT_CIRCLE_R, y: Y_TOP }; // forward run -> past the edge of the free-throw circle, level with its radius
const P2 = { x: FT_X + FT_CIRCLE_R, y: Y_BOTTOM }; // lateral slide across, level with the free-throw line
