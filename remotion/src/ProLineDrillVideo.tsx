...
const P1 = { x: FT_X + FT_CIRCLE_R * 2, y: Y_TOP }; // forward run -> past the edge of the free-throw circle, double its radius out
const P2 = { x: FT_X + FT_CIRCLE_R * 2, y: Y_BOTTOM }; // lateral slide across, level with the free-throw line
