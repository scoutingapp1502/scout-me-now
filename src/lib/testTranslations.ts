...
const testDescriptionTranslations: Record<string, Partial<Record<Language, string>>> = {
  speed: {
    en: "Setup: A straight course, marked with cones every 5 meters, over a total distance of 20-30 meters.\n\nExercise: The athlete sprints at maximum speed over the whole distance. The time is measured to evaluate sprint speed.",
    de: "Aufbau: Eine gerade Strecke, alle 5 Meter mit Hütchen markiert, über eine Gesamtdistanz von 20-30 Metern.\n\nÜbung: Der Sportler sprintet mit maximaler Geschwindigkeit über die gesamte Strecke. Die Zeit wird gemessen, um die Sprintgeschwindigkeit zu bewerten.",
    fr: "Configuration : Un parcours droit, balisé de plots tous les 5 mètres, sur une distance totale de 20 à 30 mètres.\n\nExercice : L'athlète sprinte à vitesse maximale sur toute la distance. Le temps est chronométré pour évaluer la vitesse de sprint.",
    es: "Configuración: Un recorrido recto, marcado con conos cada 5 metros, en una distancia total de 20-30 metros.\n\nEjercicio: El deportista corre a velocidad máxima toda la distancia. Se cronometra el tiempo para evaluar la velocidad de esprint.",
    it: "Configurazione: Un percorso rettilineo, segnato con coni ogni 5 metri, per una distanza totale di 20-30 metri.\n\nEsercizio: L'atleta corre alla massima velocità per tutta la distanza. Il tempo viene cronometrato per valutare la velocità di sprint.",
  },
  jumping: {
  ...
  endurance: {
    en: "Setup: Two lines marked 10 meters apart.\n\nExercise: The athlete runs back and forth between the two lines several times, at maximum speed, changing direction at each line. The total time is measured.",
    de: "Aufbau: Zwei Linien im Abstand von 10 Metern.\n\nÜbung: Der Sportler läuft mehrmals mit maximaler Geschwindigkeit zwischen den beiden Linien hin und her und wechselt bei jeder Linie die Richtung. Die Gesamtzeit wird gemessen.",
    fr: "Configuration : Deux lignes tracées à 10 mètres l'une de l'autre.\n\nExercice : L'athlète court plusieurs allers-retours entre les deux lignes à vitesse maximale, en changeant de direction à chaque ligne. Le temps total est chronométré.",
    es: "Configuración: Dos líneas marcadas a 10 metros de distancia.\n\nEjercicio: El deportista corre varias veces de ida y vuelta entre las dos líneas a velocidad máxima, cambiando de dirección en cada línea. Se cronometra el tiempo total.",
    it: "Configurazione: Due linee segnate a una distanza di 10 metri l'una dall'altra.\n\nEsercizio: L'atleta corre più volte avanti e indietro tra le due linee, alla massima velocità, cambiando direzione a ogni linea. Viene cronometrato il tempo totale.",
  },
  acceleration: {
