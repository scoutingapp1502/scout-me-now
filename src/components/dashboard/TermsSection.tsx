...
export const TERMS_SECTIONS_RO = [
  ...
  },
  {
    ...
    body: "SportRise este o platformă de scouting sportiv destinată sportivilor, scouterilor, agenților și reprezentanților de cluburi. Platforma poate fi folosită exclusiv de persoane care au împlinit vârsta de 13 ani: data nașterii este obligatorie la crearea contului și este verificată automat, iar conturile care nu îndeplinesc această condiție nu pot fi create. Dacă ai între 13 și 15 ani, crearea contului necesită și bifarea unei declarații prin care confirmi că un părinte sau tutore legal este la curent și de acord cu înregistrarea ta; această declarație este completată chiar de tine, la înregistrare, și nu presupune o verificare suplimentară a identității părintelui. Dacă ai între 16 și 18 ani, îți recomandăm să folosești Platforma cu știrea unui părinte sau tutore legal. Crearea unui cont de Descoperitor necesită împlinirea vârstei de 18 ani; data nașterii este verificată automat la înregistrare și un cont de Descoperitor nu poate fi creat de o persoană minoră, indiferent de acordul unui părinte sau tutore legal. Pentru a crea un cont trebuie să furnizezi informații corecte, complete și actualizate despre identitatea, vârsta și rolul tău; declararea unei vârste false constituie o încălcare a acestor Termeni și duce la închiderea contului. Rolurile de Descoperitor, Agent și Reprezentant de club pot fi supuse unui proces de verificare a identității și a activității profesionale, iar SportRise își rezervă dreptul de a refuza sau revoca accesul acestor roluri dacă documentele furnizate nu sunt considerate satisfăcătoare.",
  },
  {
...
export const TERMS_SECTIONS_EN = [
  ...
  },
  {
    ...
    body: "SportRise is a sports scouting platform for athletes, scouts, agents, and club representatives. The Platform may only be used by people who are at least 13 years old: your date of birth is required when creating an account and is checked automatically, and accounts that don't meet this condition cannot be created. If you're between 13 and 15, creating an account also requires checking a declaration confirming that a parent or legal guardian is aware of and agrees with your registration; this declaration is filled in by you, the minor, at signup, and does not involve any further verification of the parent's identity. If you're between 16 and 18, we recommend using the Platform with the knowledge of a parent or legal guardian. Creating a Scout (\"Descoperitor\") account requires being at least 18 years old; your date of birth is checked automatically at signup, and a Scout account cannot be created by a minor, regardless of parental consent. To create an account, you must provide accurate, complete, and up-to-date information about your identity, age, and role; declaring a false age is a breach of these Terms and results in account closure. Scout, Agent, and Club Representative roles may be subject to an identity and professional activity verification process, and SportRise reserves the right to refuse or revoke access to these roles if the documents provided are not deemed satisfactory.",
  },
  {
