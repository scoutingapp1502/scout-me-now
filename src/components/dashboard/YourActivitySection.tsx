    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-6 py-8 text-center">
          <h1 className="font-heading text-2xl text-gray-900 mb-2 leading-tight">
        ...
        {GROUPS.map((group) => (
          <div key={group.titleEn} className="mb-2">
            <p className="text-xs text-gray-500 font-body px-4 py-2 uppercase tracking-wider">
              ...
              {group.items.map((item, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3.5 hover:bg-gray-50 transition-colors text-left ${i > 0 ? "border-t border-gray-200" : ""}`}
                  >
                    <Icon className="h-5 w-5 text-gray-900 shrink-0" />
                    <span className="flex-1 text-sm text-gray-900 font-body">
